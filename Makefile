...
dartprotoc:
	...
	docker run --rm -v $(shell cd)/duo_client/lib/pb:/out -v $(shell cd)/proto:/proto protoc_container "protoc --proto_path=/proto --dart_out=grpc:/out /proto/*.proto google/protobuf/timestamp.proto"
