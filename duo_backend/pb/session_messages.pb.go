...
func (x *CreateSessionRequest) GetPin() string {
	if x != nil {
		return x.Pin
	}
	return ""
...
func (x *CreateSessionResponse) GetPin() string {
	if x != nil {
		return x.Pin
	}
	return ""
...
var file_session_messages_proto_rawDesc = []byte{
	...
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x69, 0x6e, 0x22, 0x5b, 0x0a, 0x12,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x69, 0x6e, 0x22, 0x93, 0x01, 0x0a, 0x0d, 0x53, 0x65,
