...
func (x *LoginChallengeRequest) GetChallenge() string {
	if x != nil {
		return x.Challenge
	}
	return ""
...
type LoginChallengeResponse struct {
	...
	Uuid               string `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	DecryptedChallenge string `protobuf:"bytes,2,opt,name=decryptedChallenge,proto3" json:"decryptedChallenge,omitempty"`
}
...
func (x *LoginChallengeResponse) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *LoginChallengeResponse) GetDecryptedChallenge() string {
	if x != nil {
		return x.DecryptedChallenge
	}
	return ""
}
...
var file_auth_messages_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4c, 0x0a, 0x0f, 0x52, 0x65,
	...
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x22, 0x45, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69,
	...
	0x75, 0x69, 0x64, 0x22, 0x35, 0x0a, 0x15, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x6c,
	...
	0x09, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x22, 0x5c, 0x0a, 0x16, 0x4c, 0x6f,
	...
	0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x12, 0x2e, 0x0a, 0x12, 0x64, 0x65, 0x63, 0x72,
	0x79, 0x70, 0x74, 0x65, 0x64, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x64, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x43,
	0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x22, 0x60, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69,
	...
	0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x13, 0x5a, 0x11, 0x67, 0x69,
...
var file_auth_messages_proto_goTypes = []interface{}{
	...
	(*LoginChallengeRequest)(nil),  // 3: pb.LoginChallengeRequest
	(*LoginChallengeResponse)(nil), // 4: pb.LoginChallengeResponse
	(*LoginResponse)(nil),          // 5: pb.LoginResponse
	(*timestamppb.Timestamp)(nil),  // 6: google.protobuf.Timestamp
}
var file_auth_messages_proto_depIdxs = []int32{
	6, // 0: pb.LoginResponse.expires_at:type_name -> google.protobuf.Timestamp
